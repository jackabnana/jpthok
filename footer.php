		...
		<div class="container">
			<div class="footer-top">
				...
				<div class="social sec">
					...
					<ul>
						<li><a href="<?=$get->get_facebook_url()?>"><i class="fa fa-facebook"></i></a></li>
						<li><a href="<?=$get->get_twitter_url()?>"><i class="fa fa-twitter"></i></a></li>
						<li><a href="<?=$get->get_google_plus_url()?>"><i class="fa fa-google-plus"></i></a></li>
						<li><a href="<?=$get->get_linkedin_url()?>"><i class="fa fa-linkedin"></i></a></li>
						<li><a href="<?=$get->get_youtube_url()?>"><i class="fa fa-youtube"></i></a></li>
					</ul>
				</div>
	...
	<div class="top-categories">
		<div class="container">
			<ul>
				...
				?></p></li>
				<li><b>About <?=$get->get_website_name()?>:</b><p><?=strip_tags($get->get_content(30629))?></p></li>
			</ul>
		</div>
	</div>
	<div class="copyright">
		<div class="container">
			...
			<p class="company-link">Design & Developed by <a href="http://quickmediasolution.com">QMS / IDIGITIE</a></p>
		</div>
	</div>
