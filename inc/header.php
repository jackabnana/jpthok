	...
	function hide_login(){		
		...
		$('.popup').hide();
         ...
         <div class="header-sub">
         	<div class="container">	<div class="whatsapp"><i class="fa fa-whatsapp"></i> <?=$get->get_whatsup_no()?></div> <div class="language-conveter"><div id="google_translate_element"></div><script type="text/javascript">
...
<a href="#0" class="login-btn" id="login"><i class="fa fa-sign-in"></i> Login</a></li>
 ...
 Sign up</a>
						...
						<li>
						    <!--<a href="#0" class="signin-btn" id="signup-vendor"><i class="fa fa-user-plus"></i>
 Sell with Us</a>-->
 
 <a href="<?=$site_url?>/vendor" class="signin-btn" target="_blank"><i class="fa fa-user-plus"></i>
 Sell with Us</a>
	...
	<div class="cart-section">
		...
		<p><a style="color:#fff;" href="<?=$site_url?>/cart.php"><img src="<?=$site_url?>/img/icon/cart.png"><span class="price">NRS(<span id="cart_price"><?=number_format($get->get_order_total())?></span>)</span><i>-</i><span class="items"><span id="cart_amt"><?=$cartlimit?></span> items(s)</span></a></p>
	</div>
	</nav>
	<!-----------------------popup------------------->
		...
		<div class="col-md-40 login-form-page margin-top-30px margin-bottom-30px"  >
				...
				<div class="col-md-100 margin-top-20px margin-bottom-20px ">
					<div class="col-md-100 margin-top-20px float-left" id="id-signup-fname">
						<input type="text" class="col-md-100 row-px-30 input" name="fname" id="fname" value="<?=$fname?>" placeholder="Enter Your First Name">
					</div>
					
					<div class="col-md-100 margin-top-20px float-left" id="id-signup-lname">
						<input type="text" class="col-md-100 row-px-30 input" name="lname" id="lname" placeholder="Enter Your Last Name" value="<?=$lname?>">
					</div>
