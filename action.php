...
//$site_url = 'http://localhost/thokvikreta';
...
$ToEmail = 'nagendra.qms@gmail.com,info@thokvikreta.com';
$FromEmail = 'info@thokvikreta.com';
...
$subject = 'Product Enquiry: thokvikreta';
...
<table width='600' cellspacing='0' cellpadding='0' align='center' bgcolor='#fff' style='border:1px solid #f8f8f6; padding:10px;' 
  ...
  <tr>
    <td colspan='10' align='left'>
      <span style='margin:0px;font-size:14px; color:rgb(99, 96, 96)'><b>Thank you for visiting on thokvikreta</b></span><br />
      <span style='margin:0px;font-size:12px;color:#7d7d7d;'><a style='text-decoration:none;color:#7d7d7d !important;'>We hope you enjoy your stay on thokvikreta. We're still small, so it would really help us if you can help us spread the word by telling your friends about thokvikreta. </span>
    </td>
  <tr>
   <tr>
    <td colspan='10' height='10px'></td>
  ...
  <tr>
    <td colspan='10' align='left'>
      <span style='margin:0px;font-size:11px;color:#7d7d7d;'><a style='text-decoration:none;color:#7d7d7d !important;'>We hope you enjoy your stay on thokvikreta. We're still small, so it would really help us if you can help us spread the word by telling your friends about thokvikreta. </span>
    </td>
  <tr>
  <tr>
    <td colspan='10' height='10px'></td>
...
$checkUserName = $set->checkExistVenderUserName($username);

if($checkUserName==1){
	$nowreturn ="ERROR";
	$message='<span style="color:#ff0000;">&nbsp;Username already exist<i class="fa fa-times"></i></span>';
}else{
	$nowreturn ="SUCCESS";
	$message='<span style="color:#027102;">&nbsp;<b>'.$username.'</b> Available<i class="fa fa-check"></i></span>';	
}
...
if(isset($_REQUEST['vendor_signup']))
{
	...
	else 
	{
		...
		$red = $_POST['red'];
			?>
			<!--<script>window.location.href = '<?=$red?>';</script>-->
			<script>window.location.href = '<?=$site_url?>/vendor/index.php';</script>
			<?
		} 
		else
		{
