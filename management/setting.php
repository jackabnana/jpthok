    ...
    <div class="tabContent" id="general">
      <div>
		...
		<tr>
			...
			<tr>
				<td>Website</td>
				<td><input type="text" value="<?=$settingrow->website_url?>"  name="website_url" style="width:85%; height:30px; margin-left:10px;"  placeholder="example: abc.com"/></td>
			</tr>
			...
			<tr>
				<td>Whatsup No.</td>
				<td><input type="text" value="<?=$settingrow->whatsup_no?>"  name="whatsup_no" style="width:85%; height:30px; margin-left:10px;"  /></td>
			</tr>
			...
			<tr>
				...
				<td><input type="text"  value="<?=$settingrow->address?>" name="address" style="width:85%; height:30px; margin-left:10px;"  /></td>
			</tr>
			<tr>
				<td>Copyright</td>
