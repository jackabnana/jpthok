...
<span style="float:left;">Invioce No: <?=$get->generate_invoice_no($_REQUEST['id'])?></span>
...
<tr>
    <td colspan="4"><b>FASHION XYZ PVT LTD</b><br />
B-3, Nirman Vihar,<br />
...
?> 
<tr>
<td><?=$get->get_product_name($prod_id)?>(<?=$get->get_product_code($prod_id)?>)</td>
<td align="right" width="20"><?=$qty?></td>
<td align="right" width="70">Rs. <?=$price?></td>
