...
$user = new Admin();
$currentpage = 'search-terms.php';
$currentpagetitle = 'User Searches';
$getdata = $get->get_active_data($_REQUEST['id'],'user_searches');
...
if(isset($_POST['doaction'])){
	extract($_POST);
$add = $set->do_action($action,$ids,'user_searches');
}
...
<?
$selectreview = "SELECT * FROM user_searches ";
