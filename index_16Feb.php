...
<section class="slider-section">
	...
	<div class="slider-left-banners">
		<div class="banner-top">
			...
			<img src="<?=$site_url?>/upload/ads/<?=$imgup1?>">
		</div>
		<div class="banner-left">
		     <?$imgup2 = $get->get_ads('top','home','2');?>
			<img src="<?=$site_url?>/upload/ads/<?=$imgup2?>">
		</div>
		<div class="banner-right">
		     <?$imgup3 = $get->get_ads('top','home','3');?>
			<img src="<?=$site_url?>/upload/ads/<?=$imgup3?>">
		</div>
	</div>
...
<iframe width="335" height="385" src="<?=$you_url1?>" frameborder="0" allowfullscreen></iframe>
				...
				<div class="sec2">
					<ul>
						...
						<li><a href="#"><img src="<?=$site_url?>/upload/ads/<?=$img3?>"></a></li>
						<li><a href="#"><img src="<?=$site_url?>/upload/ads/<?=$img4?>"></a></li>
					</ul>
				</div>
				
				<div class="sec3">
				    <?$img5 = $get->get_ads('bottom','home','5');?>
					<a href="#"><img src="<?=$site_url?>/upload/ads/<?=$img5?>"></a>
				</div>
				
				<div class="sec4">
				    <?$img6 = $get->get_ads('bottom','home','6');?>
					<a href="#"><img src="<?=$site_url?>/upload/ads/<?=$img6?>"></a>
				</div>
				<div class="sec5">
					<ul>
						...
						<li><a href="#"><img src="<?=$site_url?>/upload/ads/<?=$img7?>"></a></li>
						<li><a href="#"><img src="<?=$site_url?>/upload/ads/<?=$img8?>"></a></li>
						<li><a href="#"><img src="<?=$site_url?>/upload/ads/<?=$img9?>"></a></li>
					</ul>
				</div>
			</div>
		</div>
		...
		<div class="mobile">
			<div class="container">
				<div class="mobile-cat">
					...
					<ul>
						<?
						$mobile_cat = mysql_query("SELECT * FROM category WHERE parent_id = '$display_cat_id' ORDER By rand() LIMIT 6");
		...
		<div class="other-products">
			<div class="container">
				<div class="recent" id="recent">
					...
					<ul>
					    <?
			$Latest_Products = mysql_query("SELECT * FROM product WHERE best_sales LIKE '%LL%' AND status = 'active' ORDER BY rand() ");
